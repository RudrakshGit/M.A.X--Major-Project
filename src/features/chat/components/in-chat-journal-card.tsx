...
import { CheckCircle2, BookmarkPlus, Sparkles, Loader2, ExternalLink } from "lucide-react";
...
export function InChatJournalCard({
  ...
  return (
    <div className="my-3 p-4 rounded-xl bg-surface-card border border-ink/10 shadow-xs space-y-3.5 animate-in fade-in slide-in-from-bottom-2 duration-300">
      {/* Header */}
